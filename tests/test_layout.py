...
def test_required_kernel_builder_files():
    for rel in (
        ...
        "torch-ext/szl_receipt_attn/attn.py",
        "torch-ext/szl_receipt_attn/_triton.py",
        "torch-ext/szl_receipt_attn/_chain.py",
...
@pytest.mark.kernels_ci
def test_superseded_modules_removed():
    leftover = (
        "torch-ext/szl_receipt_attn/api.py",
        "torch-ext/szl_receipt_attn/const.py",
        "torch-ext/szl_receipt_attn/ops.py",
        "torch-ext/szl_receipt_attn/receipt.py",
        "torch-ext/szl_receipt_attn/reference.py",
        "torch-ext/szl_receipt_attn/selfcheck.py",
        "torch-ext/szl_receipt_attn/triton_kernel.py",
        "torch-ext/szl_receipt_attn/_ops.py",
    )
    for rel in leftover:
